        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white text-gray-900 font-sans relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-24 relative z-10">
                ...
                <section id="find-us" className="scroll-mt-16">
                    ...
                    <motion.div
                        className="w-full h-[480px] rounded-3xl border border-gray-200 shadow-xl overflow-hidden relative"
                        initial={{ opacity: 0, y: 30 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.7, delay: 0.2 }}
                    >
                        <iframe
                            title="Bookin-Hub Location Map"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.835434509374!2d-122.4194155!3d37.7749295!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809c6c8f4459%3A0xb10ed6d9b5050fa5!2sSan%20Francisco%2C%20CA!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                        ...
                        <div className="absolute top-6 left-6 z-10 hidden md:block">
                            <div className="bg-white/95 backdrop-blur-md p-6 rounded-2xl border border-gray-100 shadow-2xl max-w-sm">
                                ...
                                <p className="text-xs text-gray-600 mb-4 leading-relaxed font-medium">123 Travel Lane, Suite 400, Adventure City, CA 94103</p>
                                ...
                                <a
                                    ...
                                    className="mt-4 w-full inline-flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2.5 rounded-xl font-bold text-xs transition-all shadow-md"
                                >
