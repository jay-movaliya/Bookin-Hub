...
const HotelOwnerForgetPassword = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/hotel/owner/forgot-password`,
        { email }
      );
      ...
      setErrorMessage(
        error.response?.data?.message || "Failed to find account or send OTP."
      );
    } finally {
      setIsLoading(false);
    }
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/hotel/owner/reset-password`,
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">
            {step === 1
              ? "Enter your hotel owner email to receive an OTP"
...
export default HotelOwnerForgetPassword;
