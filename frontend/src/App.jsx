...
import HotelOwnerForgetPassword from "./Pages/Hotel/Owner/HotelOwnerForgetPassword.jsx";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/forgot-password/hotel" element={<HotelOwnerForgetPassword />} />
        ...
        <Route path="/super/dashboard" element={<AdminRoute><SuperLayout /></AdminRoute>}>
          <Route
            index
            element={<Navigate to="approved-hotel-owner" replace />}
          />
